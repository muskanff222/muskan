...
# 1.1 updated student result system with more features(31-05-2026)
# class student:
...
a=144;
num=int(input("Guess the number between 1 to 200: "));
while num!=a:
     if(num<a):
...
#2.1 guess the number game with limited attempts
a=144;
print("attemps are 5 only");
for i in range(5):
    num=int(input("Guess the number between 1 to 200: "));
    if num==a:
        print("Congratulations! You guessed the number correctly.");
